...
var _sidebar = _interopRequireDefault(__webpack_require__(/*! ./sidebar */ "./assets/jsx/sidebar.jsx"));

var _mainContent = _interopRequireDefault(__webpack_require__(/*! ./main-content */ "./assets/jsx/main-content.jsx"));

var _mainContentLogs = _interopRequireDefault(__webpack_require__(/*! ./main-content-logs */ "./assets/jsx/main-content-logs.jsx"));
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react.default.createElement(_reactRouterDom.BrowserRouter, null, _react.default.createElement("div", {
        ...
        className: "row"
      }, _react.default.createElement(_sidebar.default, null), _react.default.createElement(_reactRouterDom.Route, {
        path: "/",
        exact: true,
        component: _mainContent.default
      }), _react.default.createElement(_reactRouterDom.Route, {
        path: "/logs",
        exact: true,
        component: _mainContentLogs.default
      }))));
    }
  }]);
...
/***/ "./assets/jsx/main-content-logs.jsx":
/*!******************************************!*\
  !*** ./assets/jsx/main-content-logs.jsx ***!
  \******************************************/
/*! no static exports found */
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(MainContentLogs, _React$Component);

  function MainContentLogs() {
    _classCallCheck(this, MainContentLogs);

    return _possibleConstructorReturn(this, (MainContentLogs.__proto__ || Object.getPrototypeOf(MainContentLogs)).apply(this, arguments));
  }

  _createClass(MainContentLogs, [{
    key: "render",
    value: function render() {
  ...
  return MainContentLogs;
}(_react.default.Component);

var _default = MainContentLogs;
exports.default = _default;

/***/ }),

/***/ "./assets/jsx/main-content.jsx":
/*!*************************************!*\
  !*** ./assets/jsx/main-content.jsx ***!
  \*************************************/
/*! no static exports found */
...
function (_React$Component) {
  ...
  _createClass(MainContent, [{
    key: "render",
    value: function render() {
      var className = "main-content col-".concat(this.state.colWidth);
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(SidebarLink, _React$Component);
  ...
  function SidebarLink(props) {
    ...
    _this = _possibleConstructorReturn(this, (SidebarLink.__proto__ || Object.getPrototypeOf(SidebarLink)).call(this, props));
    /**
     * @type {Sidebar}
     */

    _this.sidebar = props.sidebar;
    _this.state = {
      textKey: props.textKey,
      active: props.active,
      url: props.url
    };
    _this.linkClick = _this.linkClick.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(SidebarLink, [{
    ...
    key: "render",
    value: function render() {
      var className = 'sidebar-link list-group-item list-group-item-action';
    ...
    key: "id",
    get: function get() {
      return "link-".concat(this.state.textKey);
    }
  }]);
...
var _sidebarLink = _interopRequireDefault(__webpack_require__(/*! ./sidebar-link */ "./assets/jsx/sidebar-link.jsx"));
...
function (_React$Component) {
  ...
  _createClass(Sidebar, [{
    key: "updateSelectedLink",
    value: function updateSelectedLink(key) {
    ...
    value: function render() {
      ...
      var eles = this.state.links.map(function (link) {
        var active = false;

        if (link.key === _this2.state.activeLink) {
          active = true;
        }
      ...
      var className = "sidebar col-".concat(this.state.colWidth);
      return _react.default.createElement("div", {
        className: className
      }, _react.default.createElement("div", {
        className: "sidebar-links list-group"
      }, eles));
    }
  }]);
...
var _app = _interopRequireDefault(__webpack_require__(/*! ./jsx/app.jsx */ "./assets/jsx/app.jsx"));
